        ...
        <div className="flex justify-between h-24">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-muted-foreground hover:text-[var(--brand)] text-sm font-medium transition-colors"
            >
              Inicio
            </button>
            <button
            ...
            <button
              ...
              className="p-2 rounded-full text-muted-foreground hover:text-[var(--brand)] hover:bg-muted transition-colors"
