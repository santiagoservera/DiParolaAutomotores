...
export function HeroSection({ onNavigate }: NavigationProps) {
  return (
    <section className="relative h-[80vh] flex items-center bg-white overflow-hidden">
      {/* Background shape */}
      <div className="absolute right-0 top-0 w-1/2 h-full bg-[#004867]/5 skew-x-[-10deg] translate-x-32 hidden lg:block" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-12 z-10">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-[#004867] leading-tight">
