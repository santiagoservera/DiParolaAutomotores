                ...
                <tr key={ct.id} className="border-b border-[#4a6fd4]/8 hover:bg-[#1a2040]/60 transition-colors">
                  ...
                  <td className="px-3 xl:px-4 py-3">
                    <div className="flex items-center justify-center gap-0.5">
                      ...
                      {canEdit && ct.estado !== 'CANCELADO' && <button onClick={() => openView(ct, 'edit')} className="p-1.5 rounded-md text-amber-400 hover:text-white hover:bg-amber-400/10 transition-colors cursor-pointer" title="Editar"><Pencil className="w-4 h-4" /></button>}
                    </div>
                  </td>
                </tr>
              ))}
              ...
              <Card key={ct.id} className="border-[#4a6fd4]/8 bg-[#131729] p-3 sm:p-4 hover:bg-[#1a2040]/60 transition-colors">
                <div className="flex items-start justify-between gap-2 mb-2">
                  ...
                  <div className="flex gap-0.5 shrink-0">
                    ...
                    {canEdit && ct.estado !== 'CANCELADO' && <button onClick={() => openView(ct, 'edit')} className="p-1.5 rounded-md text-amber-400 hover:bg-amber-400/10 cursor-pointer"><Pencil className="w-4 h-4" /></button>}
                  </div>
                </div>
